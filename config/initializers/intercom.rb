IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "dkx5lian"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "PSCnNpZdZSTKu2nW9yjijkv7qW9WMns4QnCIl-j8"
  ...
  config.user.custom_data = {
    :counselor_id => Proc.new { |current_user| current_user.counselor.id if current_user.counselor.present? },
    :stripe_customer_id => Proc.new { |current_user| current_user.stripe_customer_id }
  }
