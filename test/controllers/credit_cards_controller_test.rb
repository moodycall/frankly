...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { name: @credit_card.name, stripe_card_id: @credit_card.stripe_card_id, user_id: @credit_card.user_id }
    end
  ...
  test "should update credit_card" do
    patch :update, id: @credit_card, credit_card: { name: @credit_card.name, stripe_card_id: @credit_card.stripe_card_id, user_id: @credit_card.user_id }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
